...
public class FaceClient {
    ...
    public void faceSaver(String userName,String data) throws Exception{
        ...
        File f=new File("/Users/jimingrui/blog/src/main/webapp/static/face/"+fileName);
        f.createNewFile();
        PrintWriter out=new PrintWriter(new FileWriter("/Users/jimingrui/blog/src/main/webapp/static/face/"+fileName));
        out.println(data);
        out.close();
    }
    ...
    public String faceReader(String userName){
        String ss = "";
        try{
            BufferedReader in = new BufferedReader(new FileReader("/Users/jimingrui/blog/src/main/webapp/static/face/"+userName));

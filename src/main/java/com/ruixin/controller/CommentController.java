...
//        String file = speechClient.generateMp3(text, "/Users/jimingrui/blog/src/main/webapp/static/temp/audio");
//
//        try {
...
//        }
    ...
    @RequestMapping("/comment/play")
    @ResponseBody
    public String commentPlay(@RequestParam("comment")String comment){
        SpeechClient speechClient = SpeechClient.getInstance(APP_ID, API_KEY, SECRET_KEY);
        String file = speechClient.generateMp3(comment, "/Users/jimingrui/blog/src/main/webapp/static/temp/audio");

...
<head>
    ...
    <base href="/" >
    <title>人脸识别</title>
    <a href="/"><font style="font-size: 50px;color: #c2c2c2"></font></a>
    <meta charset="UTF-8">
...
<body background="${ctxStatic}/images/sky2.jpg">
    <br>
    <br>
    <div><font style="font-size: 50px;color: #c2c2c2;text-align:'center'" >(๑•̀ㅂ•́)و✧HBLOG</font></div>
    <h4 style="font-size: 50px;color: #c2c2c2">请把脸置于镜头正中，开始识别</h4>

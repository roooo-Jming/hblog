    ...
    <script th:inline="javascript">
        $(function() {
            $("button[name='play']").click(function () {
                var comment=$(this).siblings("input[name='play_comment']").val()
                console.log(comment)
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // 设置audio组件的音频文件地址
                        $("audio").attr("src", "");
                        //LoginController中生成的语音文件
                        $("audio").attr("src", "/temp/audio/" + data.filename);
                        // 播放语音
        ...
        <c:if test="${!empty news }">
            ...
            <div style="text-align:center">
                <button id="guanzhu"style="cursor: pointer; width: 50px;
                           ...
                           margin-top: 10px;">关注
<%--                    <i class="layui-badge fly-badge-vip"></i>--%>
                ...
                <ul class="jieda" id="jieda">
                    <li data-id="111" class="jieda-daan">
                        ...
                        <div class="detail-body jieda-body photos">
                            <button name="play" style="cursor: pointer; width: 50px;
                           height: 30px; color: white;
                           background-color:#1a7dde;
                           border: 0px; border-radius: 7px;
                           margin-top: 0px;margin-left: 10px">播放</button>
                            <input type="hidden" value="${comment.content}" name="play_comment" />
<%--                            <div style="margin:0px auto;">--%>
                                <br>
                                <audio id="audio" controls style="width:300px; margin-top: 0px; margin-left: 0px">
                                    您的浏览器不支持audio组件
                                </audio>
<%--                            </div>--%>
                        ...
                        <div class="jieda-reply"style="margin-left: 10px">
                                <span type="reply">

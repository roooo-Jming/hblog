    ...
    <script th:inline="javascript">
        $(document).ready(function () {
            document.getElementById("focus").addEventListener("click",function () {
                var info_news=$("#article").val()
                var info_user=$("#user").val()
                console.log(info_news)
                console.log(info_user)
                var data = {newsId:info_news,userName:info_user}
                $.ajax({
                    url: "/focus/getInfo",
                    type: "POST",
                    dataType: "json",
                    ...
                    <c:forEach items="${page.data}" var="news">
                        <li>
                            ...
                            <div class="fly-list-info">
                                <button id="focus">
<%--                                <a href="message/success.jsp" link>--%>
                                    <cite>ID：${news.id}</cite>
<%--                                    <i class="iconfont icon-renzheng" title="认证信息：XXX"></i>--%>
<%--                                    <input type="button" value="关注" id="button"/>--%>
<%--                                </a>--%>
